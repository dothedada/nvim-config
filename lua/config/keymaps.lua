...
map({ 'n', 'v' }, 'j', "v:count == 0 ? 'gj' : 'j'", { expr = true, silent = true }) -- Mover dentro de la línea texto hacia arriba
map({ 'n', 'v' }, 'k', "v:count == 0 ? 'gk' : 'k'", { expr = true, silent = true }) -- Mover dentro de la línea texto hacia abajo
